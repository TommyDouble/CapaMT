  ...
  return (
    <div className="wizard-block wizard-block--renforcement">
      ...
      <div className="wizard-block__body space-y-4">
        ...
        <div>
          ...
          {origTfos.length > 0 && block.tfos.some((t) => getTfoStatus(t) !== 'unchanged') && (
            <div className="mt-2 flex flex-wrap gap-2 text-xs">
              ...
              {origTfos
                .filter((t) => !block.tfos.find((x) => x.id === t.id))
                .map((t) => (
        ...
        {/* Load transfer */}
        <FormRow
          label="Transfert de charge (± MVA)"
          hint="Négatif = charge quittant cette SS · Positif = charge arrivant"
        >
          <input
            type="number"
            step="0.5"
          ...
          (() => {
            const tc = {
              ...
              mtBackup: {
                ...
                capacity: parseFloat(block.mtBackupCapacity) || 0,
              },
            };
              ...
              <div className="capacity-preview capacity-preview--blue">
                ...
                {ss && (
                  <span className="text-xs text-gray-400">
                    (actuel : N-1 = {f1(calcCapacityN1(ss.transformerConfig))} MVA)
                  </span>
                )}
              </div>
            );
