...
export function canonicalRequest(options = {}) {
  const {
    ...
    injectionFlexible = 0,
    offerDates = {},
    connectedReleasedAt = offerDates.connectedReleasedAt,
  ...
  return normalizeRequest(
    {
      ...
      assessment: {
        ...
        assignedTo: '',
        takenInChargeAt:
          assessmentStatus === 'under_study' || assessmentStatus === 'studied' ? '2026-02-01' : '',
        ...
        final: {
          load: {
            ...
            flexible: loadFlexible,
            status: loadStatus,
            source: 'FINAL',
          },
          injection: {
            requested: injection,
            permanent: injectionPermanent,
            flexible: injectionFlexible,
